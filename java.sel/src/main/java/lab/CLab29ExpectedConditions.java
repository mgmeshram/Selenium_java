...
public class CLab29ExpectedConditions {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            driver.get("http://localhost/samples/samples/waits.php");
            ...
            // urlToBe
            wait.until(ExpectedConditions.urlToBe("http://localhost/samples/samples/waits.php"));
